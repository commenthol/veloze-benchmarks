...
const packages = {
  ...
  hono: { hasRouter: true },
  'hono-with-middlewares': { extra: true, hasRouter: true, package: 'hono' },
  'hono-big-json': { extra: true, hasRouter: true, package: 'hono' },
  ...
  /// https://github.com/restify/node-restify/issues/1984
