...
const packages = {
  ...
  total: { hasRouter: true, package: 'total.js' },
  'uws-connect': { hasRouter: true, package: 'uws-connect', checked: false },
  'uws-connect-big-json': { extra: true, hasRouter: true, package: 'uws-connect', checked: false },
  'uws-connect-with-middlewares': { extra: true, package: 'uws-connect', checked: false, hasRouter: true },
  veloze: { hasRouter: true, package: 'veloze', checked: false },
  'veloze-next': { hasRouter: true, package: 'veloze', checked: false },
  'veloze-router': { hasRouter: true, package: 'veloze', checked: false },
  'veloze-big-json': { extra: true, package: 'veloze', hasRouter: true },
  'veloze-with-middlewares': { extra: true, package: 'veloze', checked: false, hasRouter: true },
